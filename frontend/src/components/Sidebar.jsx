...
const navItems = [
  ...
  { to: '/clean-space', label: 'Clean Space', icon: TrashIcon },
];
        ...
        {navItems.map((item) => {
          ...
          return (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-2.5 py-2.5 rounded-lg text-sm font-medium transition-colors group ${
